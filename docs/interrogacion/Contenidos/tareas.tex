\section{Tareas periódicas y continuas}
...
Las tareas periodicas comprenden todo lo que es algoritmos de cálculo y muestreo determinístico, las tareas continuas por otro lado se encargan  de las alarmas y advertencias, finalmente las tareas eventos son tareas de muy alta prioridad que interrumpen el proceso cuando lo requieran. 
...
Esto puede generar problemas de comunicación con la HMI, lag entre los datos desplegados o alarmas.
