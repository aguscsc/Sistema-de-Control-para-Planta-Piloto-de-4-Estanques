...
\begin{table}[ht]
    ...
    \begin{tabular}{llcc}
        ...
        \hline
        $A_1, A_3$ & Área transversal de los estanques impares & X.XX & $m^2$ \\
        $A_2, A_4$ & Área transversal de los estanques pares & X.XX & $m^2$ \\
        $a_1, a_3$ & Área del orificioo de descarga (estanques impares) & X.XX & $m^2$ \\
        $a_2, a_4$ & Área del orificio de descarga (estanques pares) & X.XX & $m^2$ \\
        $k_1$ & Ganancia de la Bomba 1 (Variador 1) & X.XX & $(m^3/s)/Hz$ \\
        $k_2$ & Ganancia de la Bomba 2 (Variador 2) & X.XX & $(m^3/s)/Hz$ \\
