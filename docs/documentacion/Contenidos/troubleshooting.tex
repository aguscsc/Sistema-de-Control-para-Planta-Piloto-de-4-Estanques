\clearpage
\section{Diagnóstico y Resolución de Problemas en la Puesta en Marcha}
...
\subsection{Validación en Planta Real}

% ============================================================
% ESPACIO PARA COMPLETAR CON LOS RESULTADOS DE LA SESIÓN FINAL
% ============================================================
\textit{[Esta subsección se completará con las métricas medidas en la sesión final sobre la planta física: respuesta al escalón de setpoint, sobrepaso final, tiempo de asentamiento y comportamiento en rechazo de perturbación, empleando la configuración final del controlador ($a_0 \approx 0{,}90$ identificado con prefiltro y congelado, $T=10$, sin feed-forward sobre HOREXT, término predictivo con $\Delta y$ promediado por ventana).]}
